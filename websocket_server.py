...
def handle_websocket_logic(ws):
    ...
    # 4. Send greeting (plays to caller)
    async def send_greeting():
        await asyncio.sleep(1) # Delay as per reference
        greeting_text = "Hello, and welcome to our property service. How can I assist you with your search today?"
        await get_speech(greeting_text)

    # Run greeting in background thread
